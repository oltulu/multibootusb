...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_select_usb_disk.setText(_translate("MainWindow", "<b>USB Disk Seçin</b>"))
        self.button_detect_drives.setText(_translate("MainWindow", "Sürücü Tara"))
        self.checkbox_all_drives.setText(_translate("MainWindow", "Tüm Sürücüler"))
        self.group_usb_details.setTitle(_translate("MainWindow", "USB Detayları"))
        self.label_usb_dev.setText(_translate("MainWindow", "Sürücü:"))
        self.label_usb_vendor.setText(_translate("MainWindow", "Üretici:"))
        self.label_usb_model.setText(_translate("MainWindow", "Model:"))
        self.label_usb_size.setText(_translate("MainWindow", "Boyut:"))
        self.label_usb_mount.setText(_translate("MainWindow", "Bağlı:"))
        self.label_usb_type.setText(_translate("MainWindow", "Tür:"))
        self.label_usb_fs.setText(_translate("MainWindow", "Dosya Sistemi:"))
        self.image_details_group.setTitle(_translate("MainWindow", "Kalıp Detayları"))
        self.label_image_type.setText(_translate("MainWindow", "Tür:"))
        self.label_image_size.setText(_translate("MainWindow", "Boyut:"))
        self.label_image_bootable.setText(_translate("MainWindow", "Boot:"))
        self.button_browse_image.setText(_translate("MainWindow", "Araştır"))
        self.label_select_image.setText(_translate("MainWindow", "<b>Kalıp Seç</b>"))
        self.button_uninstall_distro.setText(_translate("MainWindow", "Dağıtımı Kaldır"))
        self.button_install_distro.setText(_translate("MainWindow", "Dağıtım Ekle"))
        self.slider_persistence.setToolTip(_translate("MainWindow", "Kalıcı boyutu seçin. Bazı dağıtımlar kalıcılığı desteklemeyebilir..."))
        self.label_persistence.setText(_translate("MainWindow", "Kalıcı Boyut"))
        ...
        self.button_write_image_to_disk.setText(_translate("MainWindow", "Kalıbı USB Belleğe Yazdır"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600; color:#ff0000;\">UYARI!</span></p><p align=\"center\"><span style=\" color:#000000;\">Bu işlem, seçilen disk üzerindeki </span><span style=\" font-weight:600; color:#000000;\">TÜM</span><span style=\" color:#000000;\"> verileri yok eder.</span></p><p align=\"center\"><span style=\" color:#000000;\">Lütfen hedef diskini dikkatlice seçin.</span></p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_imager), _translate("MainWindow", "Kalıbı Diske Yaz"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Install Syslinux"))
        self.check_install_sys_only.setText(_translate("MainWindow", "Yalnızca syslinux'u yükleyin (mevcut yapılandırmalar değiştirilmeyecektir)."))
        self.check_install_sys_all.setText(_translate("MainWindow", "Syslinux'u yükleyin ve gerekli tüm dosyaları kopyalayın."))
        self.button_install_syslinux.setText(_translate("MainWindow", "Kur"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Syslinux.cfg"))
        self.button_edit_syslinux.setText(_translate("MainWindow", "Düzenle"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"justify\">Syslinux.cfg dosyasını varsayılan düzenleyiciyi kullanarak düzenleyin. </p><p align=\"justify\">Syslinux.cfg dosyasını düzenlerken <span style=\" font-weight:600; color:#ff0000;\">DİKKATLİ OLUN!</span> </p></body></html>"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_syslinux), _translate("MainWindow", "Syslinux'u Kur"))
        self.groupBox_4.setTitle(_translate("MainWindow", "USB Dene :: Önyüklenebilir USB sürücüsünü yeniden başlatmadan test edin"))
        self.combo_usb_boot_ram.setItemText(0, _translate("MainWindow", "Varsayılan"))
        ...
        self.label_4.setText(_translate("MainWindow", "RAM boyutu seçin:"))
        self.boot_usb_qemu.setText(_translate("MainWindow", "Boot &USB"))
        self.label_5.setText(_translate("MainWindow", "MB"))
        self.groupBox_5.setTitle(_translate("MainWindow", "ISO Dene :: Önyüklenebilir USB sürücüsünü yeniden başlatmadan test edin"))
        self.label_3.setText(_translate("MainWindow", "RAM boyutu seçin:"))
        self.boot_iso_qemu.setText(_translate("MainWindow", "Boot &ISO"))
        self.combo_iso_boot_ram.setItemText(0, _translate("MainWindow", "Varsayılan"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_testboot), _translate("MainWindow", "ISO/USB Dene"))
        self.menuFile.setTitle(_translate("MainWindow", "&Dosya"))
        self.menu_Help.setTitle(_translate("MainWindow", "&Yardım"))
        self.action_Quit.setText(_translate("MainWindow", "&Çıkış"))
        self.action_About.setText(_translate("MainWindow", "&Hakkında"))
